...
class Database():
    ...
    def __init_sqlite(self):
        return [(
            f"CREATE TABLE IF NOT EXISTS stock_info (id integer PRIMARY KEY, code character(255) NOT NULL, name character(255) NOT NULL, pub_date date NOT NULL, first_vol real NOT NULL, pub_price real NOT NULL, curr_vol real NOT NULL, treasury_shares real NOT NULL, pub_vol real NOT NULL, fr_owner real NOT NULL, fr_owner_rat real NOT NULL, fr_vol_remain real NOT NULL, curr_price real NOT NULL, market_capital real NOT NULL, category character(255) NOT NULL, exchanges character(255) NOT NULL);"), (
            f"CREATE TABLE IF NOT EXISTS stock_price (id integer PRIMARY KEY, code character(255) NOT NULL, date date NOT NULL, ref_price real NOT NULL, diff_price real NOT NULL, diff_price_rat real NOT NULL, close_price real NOT NULL, vol integer NOT NULL, open_price real NOT NULL, highest_price real NOT NULL, lowest_price real NOT NULL, transactions integer NOT NULL, foreign_buy integer NOT NULL, foreign_sell integer NOT NULL);"
        )]
    

    def __init_postgresql(self):
        return [(
            f"CREATE TABLE IF NOT EXISTS public.stock_info (id serial PRIMARY KEY, code character(255) NOT NULL, name character(255) NOT NULL, pub_date date NOT NULL, first_vol real NOT NULL, pub_price real NOT NULL, curr_vol real NOT NULL, treasury_shares real NOT NULL, pub_vol real NOT NULL, fr_owner real NOT NULL, fr_owner_rat real NOT NULL, fr_vol_remain real NOT NULL, curr_price real NOT NULL, market_capital real NOT NULL, category character(255) NOT NULL, exchanges character(255) NOT NULL);"), (
            f"CREATE TABLE IF NOT EXISTS public.stock_price (id serial PRIMARY KEY, code character(255) NOT NULL, date date NOT NULL, ref_price real NOT NULL, diff_price real NOT NULL, diff_price_rat real NOT NULL, close_price real NOT NULL, vol integer NOT NULL, open_price real NOT NULL, highest_price real NOT NULL, lowest_price real NOT NULL, transactions integer NOT NULL, foreign_buy integer NOT NULL, foreign_sell integer NOT NULL);"
        )]
